...
export function transformJSX(
  ...
  try {
    ...
    // Separate CSS imports — they're stripped from code and injected as <style> tags instead
...
export function createImportMap(files: Map<string, string>): ImportMapResult {
  ...
  for (const [path, content] of files) {
    if (
      ...
      // Register extension-less variants so imports without extensions resolve correctly
